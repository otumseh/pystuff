...
# reviews = [rvw.get_text() for rvw in fullpage.select(".s-item .s-item__reviews-count")]
...
list1.to_csv('/Users/HAL2665/Desktop/Coding/i73770toCSV_Test2.csv')