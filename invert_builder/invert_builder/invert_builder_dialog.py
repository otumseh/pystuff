...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'invert_builder_dialog_base.ui'))


class SSI_InvertsDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(SSI_InvertsDialog, self).__init__(parent)
